 ...
 **/
PdfReader.prototype.parseFileItems = function(pdfFilePath, password = '', itemHandler){
  ...
  pdfParser.loadPDF(pdfFilePath, password, verbosity);
};
...
PdfReader.prototype.parseBuffer = function(pdfBuffer, password = '', itemHandler){
  ...
  var verbosity = this.options.debug ? 1 : 0;
  pdfParser.parseBuffer(pdfBuffer, password, verbosity);
};
